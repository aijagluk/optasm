...
#ifndef OPCODE_LOOP_H
#define OPCODE_LOOP_H
...
class GOpcodeLOOP : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeLOOP(QWidget *parent = 0);

    explicit GOpcodeLOOP(QString op1, QWidget* parent = 0)
