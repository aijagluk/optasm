...
GOpcodeLEA::GOpcodeLEA(QWidget *parent)
    :QWidget(parent){

    initUI();
}

void GOpcodeLEA::initUI(void){
    ...
    QLabel* plblLEA = new QLabel("<h1><strong>lea</strong></h1>");
    QLabel* plblComma = new QLabel("<h1><strong>,</strong></h1>");

    QHBoxLayout* phblGeneral = new QHBoxLayout();
    phblGeneral->addStretch();
    phblGeneral->addWidget(plblLEA);
...
QString GOpcodeLEA::sourceCode(void){
    QString str;
    str.append("lea ");
    str.append(m_strOp1);
    str.append(", ");
...
void GOpcodeLEA::clearSource(void){
    m_pleOp1->clear();
    m_pleOp2->clear();
}

void GOpcodeLEA::saveData(void){
    setOp1(m_pleOp1->text());
    setOp2(m_pleOp2->text());
}

int GOpcodeLEA::calcEA(QString str){
