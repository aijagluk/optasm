...
#ifndef OPCODE_CALL_H
#define OPCODE_CALL_H
...
class GOpcodeCALL : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeCALL(QWidget *parent = 0);

    explicit GOpcodeCALL(QString op1, QWidget* parent = 0)
