...
#ifndef OPCODE_JNBE_H
#define OPCODE_JNBE_H
...
class GOpcodeJNBE : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeJNBE(QWidget *parent = 0);

    explicit GOpcodeJNBE(QString op1, QWidget* parent = 0)
