...
GOpcodeREPNE_MOVS::GOpcodeREPNE_MOVS(QWidget *parent)
    :QWidget(parent){

    initUI();
}

void GOpcodeREPNE_MOVS::initUI(void){
    ...
    QLabel* plblREPNE_MOVS = new QLabel("<h1><strong>repne movs</strong></h1>");
    QLabel* plblComma = new QLabel("<h1><strong>,</strong></h1>");

    QHBoxLayout* phblGeneral = new QHBoxLayout();
    phblGeneral->addStretch();
    phblGeneral->addWidget(plblREPNE_MOVS);
...
QString GOpcodeREPNE_MOVS::sourceCode(void){
    QString str;
    str.append("repne movs ");
    str.append(m_strOp1);
    str.append(", ");
    str.append(m_strOp2);
...
void GOpcodeREPNE_MOVS::clearSource(void){
    m_pleOp1->clear();
    m_pleOp2->clear();
}

void GOpcodeREPNE_MOVS::saveData(void){
    setOp1(m_pleOp1->text());
    setOp2(m_pleOp2->text());
}

void GOpcodeREPNE_MOVS::analyse(void){
