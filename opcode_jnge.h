...
#ifndef OPCODE_JNGE_H
#define OPCODE_JNGE_H
...
class GOpcodeJNGE : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeJNGE(QWidget *parent = 0);

    explicit GOpcodeJNGE(QString op1, QWidget* parent = 0)
