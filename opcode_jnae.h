...
#ifndef OPCODE_JNAE_H
#define OPCODE_JNAE_H
...
class GOpcodeJNAE : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeJNAE(QWidget *parent = 0);

    explicit GOpcodeJNAE(QString op1, QWidget* parent = 0)
