...
#ifndef OPCODE_REP_MOVS_H
#define OPCODE_REP_MOVS_H
...
class GOpcodeREP_MOVS : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeREP_MOVS(QWidget *parent = 0);

    explicit GOpcodeREP_MOVS(QString op1, QString op2, QWidget* parent = 0)
