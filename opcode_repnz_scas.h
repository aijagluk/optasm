...
#ifndef OPCODE_REPNZ_SCAS_H
#define OPCODE_REPNZ_SCAS_H
...
class GOpcodeREPNZ_SCAS : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeREPNZ_SCAS(QWidget *parent = 0);

    explicit GOpcodeREPNZ_SCAS(QString op1, QWidget* parent = 0)
