...
#ifndef OPCODE_JNLE_H
#define OPCODE_JNLE_H
...
class GOpcodeJNLE : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeJNLE(QWidget *parent = 0);

    explicit GOpcodeJNLE(QString op1, QWidget* parent = 0)
