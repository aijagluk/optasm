...
void GOpcodeTEST::initUI(void){
    ...
    QLabel* plblTEST = new QLabel("<h1><strong>test</strong></h1>");
    QLabel* plblComma = new QLabel("<h1><strong>,</strong></h1>");

    QHBoxLayout* phblGeneral = new QHBoxLayout();
    phblGeneral->addStretch();
    phblGeneral->addWidget(plblTEST);
...
void GOpcodeTEST::clearSource(void){
    m_pleOp1->clear();
    m_pleOp2->clear();
}

void GOpcodeTEST::saveData(void){
    setOp1(m_pleOp1->text());
    setOp2(m_pleOp2->text());
}

int GOpcodeTEST::calcEA(QString str){
