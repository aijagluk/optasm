...
#ifndef OPCODE_REPZ_CMPS_H
#define OPCODE_REPZ_CMPS_H
...
class GOpcodeREPZ_CMPS : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeREPZ_CMPS(QWidget *parent = 0);

    explicit GOpcodeREPZ_CMPS(QString op1, QWidget* parent = 0)
