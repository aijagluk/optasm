...
#ifndef OPCODE_REPE_CMPS_H
#define OPCODE_REPE_CMPS_H
...
class GOpcodeREPE_CMPS : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeREPE_CMPS(QWidget *parent = 0);

    explicit GOpcodeREPE_CMPS(QString op1, QString op2, QWidget* parent = 0)
