...
GOpcodeLES::GOpcodeLES(QWidget *parent)
    :QWidget(parent){

    initUI();
}

void GOpcodeLES::initUI(void){
    ...
    QLabel* plblLES = new QLabel("<h1><strong>les</strong></h1>");
    QLabel* plblComma = new QLabel("<h1><strong>,</strong></h1>");

    QHBoxLayout* phblGeneral = new QHBoxLayout();
    phblGeneral->addStretch();
    phblGeneral->addWidget(plblLES);
...
QString GOpcodeLES::sourceCode(void){
    QString str;
    str.append("les ");
    str.append(m_strOp1);
    str.append(", ");
...
void GOpcodeLES::clearSource(void){
    m_pleOp1->clear();
    m_pleOp2->clear();
}

void GOpcodeLES::saveData(void){
    setOp1(m_pleOp1->text());
    setOp2(m_pleOp2->text());
}

int GOpcodeLES::calcEA(QString str){
...
void GOpcodeLES::analyse(void){
    ...
    if(oper1 == BASE_REGISTER && oper2 == MEMORY){
