...
#ifndef OPCODE_REPNE_MOVS_H
#define OPCODE_REPNE_MOVS_H
...
class GOpcodeREPNE_MOVS : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeREPNE_MOVS(QWidget *parent = 0);

    explicit GOpcodeREPNE_MOVS(QString op1, QString op2, QWidget* parent = 0)
