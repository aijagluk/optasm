...
GOpcodeLDS::GOpcodeLDS(QWidget *parent)
    :QWidget(parent){

    initUI();
}

void GOpcodeLDS::initUI(void){
    ...
    QLabel* plblLDS = new QLabel("<h1><strong>lds</strong></h1>");
    QLabel* plblComma = new QLabel("<h1><strong>,</strong></h1>");

    QHBoxLayout* phblGeneral = new QHBoxLayout();
    phblGeneral->addStretch();
    phblGeneral->addWidget(plblLDS);
...
QString GOpcodeLDS::sourceCode(void){
    QString str;
    str.append("lds ");
    str.append(m_strOp1);
    str.append(", ");
...
void GOpcodeLDS::clearSource(void){
    m_pleOp1->clear();
    m_pleOp2->clear();
}

void GOpcodeLDS::saveData(void){
    setOp1(m_pleOp1->text());
    setOp2(m_pleOp2->text());
}

int GOpcodeLDS::calcEA(QString str){
