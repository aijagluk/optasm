...
#ifndef OPCODE_REPNZ_CMPS_H
#define OPCODE_REPNZ_CMPS_H
...
class GOpcodeREPNZ_CMPS : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeREPNZ_CMPS(QWidget *parent = 0);

    explicit GOpcodeREPNZ_CMPS(QString op1, QString op2, QWidget* parent = 0)
