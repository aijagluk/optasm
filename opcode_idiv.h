...
#ifndef OPCODE_IDIV_H
#define OPCODE_IDIV_H
...
class GOpcodeIDIV : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeIDIV(QWidget *parent = 0);

    explicit GOpcodeIDIV(QString op1, QWidget* parent = 0)
