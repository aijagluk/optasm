...
void GOpcodeADD::initUI(void){
    ...
    QLabel* plblADD = new QLabel("<h1><strong>add</strong></h1>");
    QLabel* plblComma = new QLabel("<h1><strong>,</strong></h1>");

    QHBoxLayout* phblGeneral = new QHBoxLayout();
    phblGeneral->addStretch();
    phblGeneral->addWidget(plblADD);
...
void GOpcodeADD::clearSource(void){
    m_pleOp1->clear();
    m_pleOp2->clear();
}

void GOpcodeADD::saveData(void){
    setOp1(m_pleOp1->text());
    setOp2(m_pleOp2->text());
}

int GOpcodeADD::calcEA(QString str){
