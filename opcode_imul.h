...
#ifndef OPCODE_IMUL_H
#define OPCODE_IMUL_H
...
class GOpcodeIMUL : public QWidget{
    Q_OBJECT
public:
    explicit GOpcodeIMUL(QWidget *parent = 0);

    explicit GOpcodeIMUL(QString op1, QWidget* parent = 0)
