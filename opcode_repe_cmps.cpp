...
GOpcodeREPE_CMPS::GOpcodeREPE_CMPS(QWidget *parent)
    :QWidget(parent){

    initUI();
}

void GOpcodeREPE_CMPS::initUI(void){
    ...
    QLabel* plblREPE_CMPS = new QLabel("<h1><strong>repe cmps</strong></h1>");
    QLabel* plblComma = new QLabel("<h1><strong>,</strong></h1>");

    QHBoxLayout* phblGeneral = new QHBoxLayout();
    phblGeneral->addStretch();
    phblGeneral->addWidget(plblREPE_CMPS);
...
QString GOpcodeREPE_CMPS::sourceCode(void){
    QString str;
    str.append("repe cmps ");
    str.append(m_strOp1);
    str.append(", ");
    str.append(m_strOp2);
...
void GOpcodeREPE_CMPS::clearSource(void){
    m_pleOp1->clear();
    m_pleOp2->clear();
}

void GOpcodeREPE_CMPS::saveData(void){
    setOp1(m_pleOp1->text());
    setOp2(m_pleOp2->text());
}

void GOpcodeREPE_CMPS::analyse(void){
