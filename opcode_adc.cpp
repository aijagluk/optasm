...
void GOpcodeADC::initUI(void){
    ...
    QLabel* plblADC = new QLabel("<h1><strong>adc</strong></h1>");
    QLabel* plblComma = new QLabel("<h1><strong>,</strong></h1>");

    QHBoxLayout* phblGeneral = new QHBoxLayout();
    phblGeneral->addStretch();
    phblGeneral->addWidget(plblADC);
...
void GOpcodeADC::clearSource(void){
    m_pleOp1->clear();
    m_pleOp2->clear();
}

void GOpcodeADC::saveData(void){
    setOp1(m_pleOp1->text());
    setOp2(m_pleOp2->text());
}

int GOpcodeADC::calcEA(QString str){
